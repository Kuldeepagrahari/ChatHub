...
const Login = () => {
  ...
  return (
    ...
    <Container component={"main"} maxWidth="xs" fullwidth sx={{ display: "flex", alignItems: "center", justifyContent: "center"}}>
      <Paper elevation={3} sx={{ padding: 4, width: "25vw", display: "flex", flexDirection: "column", alignItems: "center"}}>
        {isLogin ?
          <>
            <Typography sx={{}} variant="h4">Login</Typography>
